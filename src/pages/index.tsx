...
export default function Home() {
    ...
    <div className="relative pt-6 pb-16 sm:pb-24">
        ...
        <nav
            className="relative mx-auto flex items-center justify-between  sm:px-6 md:px-16"
            aria-label="Global"
        >
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-8 mt-24">
            <div className="px-4 sm:px-6 sm:text-center md:mx-auto md:max-w-2xl lg:col-span-6 lg:flex lg:items-center lg:text-left">
                ...
                <h1 className="mt-4 text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
                    Craft a fake <span className="text-blue-400">Tweet</span> and conquer the Joker world!
                </h1>
