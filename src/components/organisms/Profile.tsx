            ...
            <section className="pt-3 px-4 pb-0 mb-4">
                ...
                <div className="flex flex-row text-gray-300 my-2 space-x-3">
                    <div className="flex items-center">
                        ...
                        <span style={{ "fontSize": "15px"}} className="text-skin-muted">Contact: twitter@kim.com</span>
                    </div>
                    <div className="flex items-center">
                        ...
                        <span style={{ "fontSize": "15px"}} className="text-skin-accent">kim.com</span>
                    </div>
                    <div className="flex items-center">
                        ...
                        <span style={{ "fontSize": "15px"}} className="text-skin-muted">Joined June 2012</span>
                    </div>
                </div>

                <div className="flex flex-row space-x-5">
                    <Stat amount="18.8K" name="Following" />
                    <Stat amount="1.2M" name="Followers" />
                </div>
